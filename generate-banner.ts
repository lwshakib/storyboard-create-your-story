...
async function main() {
  const prompt = "A cinematic, ultra-wide web banner for an AI-powered storyboard and presentation builder application. Showcase a futuristic and creative workspace with multiple glowing slides, layout grids, and story panels floating in mid-air, connected by glowing digital data streams. Dark mode aesthetics, deep blues and neon purples, professional, clean, and sleek design. The scene conveys the magic of artificial intelligence turning raw ideas into beautiful, structured visual sequences.";
  ...
  console.log("Image successfully generated. Downloading from Cloudinary:", result.image);
