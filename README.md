...
- **AI Text/JSON**: [Google GenAI (Gemini 3.1 Flash)](https://ai.google.dev/)
- **Asset Management**: [AWS S3](https://aws.amazon.com/s3/) (or S3-compatible storage)
...
4.  **S3 Bucket Setup:**
    ...
    Initialize your storage bucket and CORS settings:
